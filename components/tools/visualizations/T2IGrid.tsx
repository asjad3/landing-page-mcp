...
export function T2IGrid() {
  return (
    ...
    >
      <div className="absolute inset-0 rounded-xl overflow-hidden flex flex-col gap-2.5 p-3" style={{ background: "rgba(0,0,0,0.04)" }}>
        ...
        <span className="font-sans text-[12px] font-medium shrink-0" style={{ color: "rgba(0,0,0,0.35)" }}>
          Generations
        </span>
      </div>
    </ChatMock>
